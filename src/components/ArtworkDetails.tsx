    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex flex-col max-w-5xl w-full md:h-auto overflow-hidden bg-white border-0 shadow-lg p-0">
        <div className="w-full flex flex-col">
          ...
          {/* Artwork Information - With improved layout and white background */}
          <div className="px-6 pb-6 w-full bg-white">
            <div className="flex flex-col md:flex-row md:items-center justify-between max-w-3xl mx-auto">
              ...
              <div className="mt-2 md:mt-0 text-sm text-muted-foreground">
                <div className="inline-flex items-center gap-x-2">
                  ...
                  {currentArtwork.price && <span className="font-medium text-foreground ml-2">{currentArtwork.price}</span>}
                </div>
              </div>
            </div>
