...
const galleryImages = [{
  id: 1,
  src: 'https://dl.dropboxusercontent.com/s/fi/fon52yeofhk9l8qw5fujp/2L5A5963.jpg?rlkey=vavbxmfxxu42hm6uc39u84k3l&st=aglaqi5o&dl=0',
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto text-center mb-16 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-medium mt-2">Gallery</h1>
             <h1 className="text-4xl md:text-5xl font-Prosjekt mt-2">
          </h1>
