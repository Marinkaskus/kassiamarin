      ...
      <section className="pt-32 pb-20">
        <div className="container-custom">
          ...
          <div className="space-y-20">
            {projectsData.map((project, index) => <div key={project.id} className="relative">
                <ProjectCard project={project} index={index} onVideoPlay={openVideoDialog} />
              </div>)}
          </div>
        </div>
      </section>
      
      <VideoDialog open={videoDialogOpen} videoUrl={currentVideoUrl} onOpenChange={setVideoDialogOpen} />
    </Layout>;
};
